...
## title: Creating Custom CLI Plugins
description: Build, test, and publish external plugins for the Contentstack CLI using the oclif framework and Contentstack CLI utilities.
url: /cli/miscellaneous/creating-custom-plugins
sidebar: cliSidebar
