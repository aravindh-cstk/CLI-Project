...
- **Contentstack CLI v2 installed**: See [Install the Contentstack CLI](/docs/headless-cms/install-the-cli/v1). This provides the `csdx` command used throughout this doc.
