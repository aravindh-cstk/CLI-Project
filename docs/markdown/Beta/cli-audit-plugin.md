...
- [CLI installed](/docs/headless-cms/install-the-cli/v1) and [configured](/docs/headless-cms/configure-regions-in-the-cli) (version 1.9.1 or above)
...
| `--modules=modules` | - | Provide the list of modules to be audited.<br>Supported values: `content-types`, `global-fields`, `entries`, `extensions`, `workflows`, `custom-roles`, `assets`, `field-rules` |
...
| `--modules` | - | Modules to audit.<br>Options: `content-types`, `global-fields`, `entries`, `extensions`, `workflows`, `custom-roles`, `assets`, `field_rules` |
