...
seo_title: "Audit Plugin | V1.x.x | Contentstack"
...
This check validates the structural completeness of `publish_details` only. It does not check an asset's scan or quarantine status. For asset-scan gating during publish, see [Bulk Publish and Unpublish Content](/docs/headless-cms/cli-bulk-publish-and-unpublish-content/v1#bulk-publish-all-assets).
