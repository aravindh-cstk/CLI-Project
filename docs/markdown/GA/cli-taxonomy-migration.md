...
seo_title: "Taxonomy Migration | V1.x.x | Contentstack"
seo_description: "Taxonomy Migration Contentstack CLI utility lets you perform the taxonomy migration operation on a stack."
---
...
- [export-to-csv](/docs/headless-cms/cli-export-content-to-csv-file/v1) plugin
...
- [CLI installed](/docs/headless-cms/install-the-cli/v1) and [configured](/docs/headless-cms/configure-regions-in-the-cli/v1) (version 1.11.0 and above)
- [CLI authenticated](/docs/headless-cms/cli-authentication/v1)
- CSV file (generated using the [export-to-csv](/docs/headless-cms/cli-export-content-to-csv-file/v1) plugin or a [CSV template](https://github.com/contentstack/cli/blob/v2.0.0-beta/packages/contentstack-migration/examples/taxonomies/test_taxonomies.csv))
