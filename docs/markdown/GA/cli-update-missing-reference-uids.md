...
seo_title: "Update Missing Reference UIDs for Entries, Assets, and Extensions | V1.x.x | Contentstack"
seo_description: "Update the missing reference UIDs of entries, assets, and extensions in your destination stack after the Import operation."
---
...
- [CLI installed](/docs/headless-cms/install-the-cli/v1) and [configured](/docs/headless-cms/configure-regions-in-the-cli/v1) (version 1.17.4 and above)
...
1. [Import the data](/docs/headless-cms/import-content-using-the-cli/v1) from the source stack using the `cm:stacks:import` command.
...
4. Find the `05-Update-reference-entry-from-mapper` script in the `examples` folder. Execute the script using the [Migration](/docs/headless-cms/migrate-your-content-using-the-cli-migration-command/v1) command as follows:
