...
seo_title: "Query-based Export | V1.x.x | Contentstack"
seo_description: "Use the Contentstack CLI plugin to export content types using queries with automatic dependency and reference support."
---
...
- [CLI installed](/docs/headless-cms/install-the-cli/v1) and [configured](/docs/headless-cms/configure-regions-in-the-cli/v1) (version 1.44 or higher)
