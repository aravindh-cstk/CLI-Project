...
seo_title: "Bulk Publish and Unpublish Content | Old Commands | Contentstack"
seo_description: "Use the CLI to bulk publish and unpublish entries and assets in Contentstack, streamlining content deployment across environments."
---
...
> **Additional Resources**: If you want to migrate your content from one stack to another, refer to the [Migration](/docs/headless-cms/migrate-your-content-using-the-cli-migration-command) guide.
