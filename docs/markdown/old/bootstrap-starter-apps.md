...
seo_title: "Bootstrap Starter Apps using the CLI | Old Commands | Contentstack Documentation"
seo_description: "Learn how to Bootstrap Starter Apps using the CLI"
---
